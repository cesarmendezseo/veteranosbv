...
class CrearAdministrador extends Component
{
    ...
    public function updatedBuscarCampeonato()
    {

        $campeonato = Campeonato::where('id', $this->buscarCampeonato)->first();
    ...
    {
        return view('livewire.sanciones.crear-administrador');
    }
}
