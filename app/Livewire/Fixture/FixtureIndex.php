...
class FixtureIndex extends Component
{
    ...
    public function mount()
    {
        ...
        $this->anioSeleccionado = $this->aniosDisponibles[0] ?? null;
        ...
        if ($this->anioSeleccionado) {
            ...
            $this->campeonatoSeleccionado = $this->campeonatos->first()->id ?? null;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.fixture.fixture-index', compact('encuentrosAgrupados'));
    }
}
