<x-layouts.app :title="__('importar exel')">
    <div class="max-w-md mx-auto mt-10">
        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            ...
            <div>
                <h1> <span class="font-medium underline decoration-blue-500">Importar archivo exel</h1>
            </div>
        </div>
        <form action="{{ route('jugadores.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <label for="dropzone-file"
                    ...
                    <div class="flex flex-col items-center justify-center text-body pt-5 pb-6 ">
                        ...
                        <p class="mb-2 text-sm"><span class="font-semibold">Click para subir</span> o arrastre hasta
                            aqui</p>
                        <p class="text-xs">Archivo Excel (.xlsx, .csv)</p>
                    </div>
                    <input id="dropzone-file" type="file" class="hidden" name="file" required />
                </label>
            </div>

            <button type="submit" class="cursor-pointer mt-2 px-4 py-2 bg-blue-600 text-white rounded">Importar
                Datos</button>
