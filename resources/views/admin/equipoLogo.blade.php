<x-layouts.app :title="__('upload logo')">
    <div class="max-w-md mx-auto mt-10">
        ...
        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            ...
            <div>
                <h1> <span class="font-medium underline decoration-blue-500">Cargar logo para</span>: {{
                    strtoupper($equipo->nombre) }}</h1>
            </div>
        </div>
        @if(session('success'))
            ...
            <div class="flex flex-col items-center justify-center w-full">
                <label for="file-input"
                    ...
                    <div id="upload-placeholder"
                        class="animate-pulse flex flex-col items-center justify-center pt-5 pb-6">
