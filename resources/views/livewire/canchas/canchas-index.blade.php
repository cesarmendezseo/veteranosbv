                 ...
                 <td class="px-6 py-4 text-center">
                     ...
                     <div class="hidden md:flex gap-2 justify-center">
                        @adminOrCan()
                         ...
                         {{-- Borrar --}}
                         <button wire:click="$dispatch('confirmar-baja',{id: {{ $cancha->id }} })"
     ...
     <div class="md:hidden  space-y-4 min-h-screen">
         ...
         <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4 border dark:border-gray-700">
             <div class="flex justify-between items-center mb-2">
                 <h3 class="text-lg font-bold text-gray-900 dark:text-white"><span class="text-gray-600 dark:text-accent">Nombre:</span> {{ucwords($cancha->nombre)}}</h3>
             ...
             <div class="grid grid-cols-1 md:grid-cols-1 gap-y-4 gap-x-6 text-gray-700 dark:text-[#efb810]">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-1 gap-y-4 gap-x-6 text-[#efb810] font-semibold dark:text-gray-300">
                     ...
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-[#efb810]">Nombre :</strong> {{ ucwords(strtolower($canchaSeleccionada->nombre)) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-[#efb810]">Direccion :</strong> {{ ucwords(strtolower($canchaSeleccionada->direccion)) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-[#efb810]">Ciudad :</strong> {{ ucwords(strtolower($canchaSeleccionada->ciudad)) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-[#efb810]">Provincia :</strong> {{ ucwords(strtolower($canchaSeleccionada->provincia)) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-[#efb810]">Cod.Pos. :</strong> {{ ucwords(strtolower($canchaSeleccionada->cod_pos)) }}
                     </p>

                 </div>

                 @else
                 <p class="text-center text-gray-600 dark:text-gray-400 py-4">No se ha seleccionado ninguna cancha para mostrar.</p>
                 @endif
             </div>
         </div>
     </div>
