<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <tbody>
            ...
            <tr
                ...
                <th scope=" row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="text-base font-semibold dark:text-white">{{ ucwords($cancha->nombre) }}</div>
                </th>
                <th scope=" row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="font-normal text-gray-500 dark:text-white"> {{ ucfirst($cancha->direccion) }}</div>
                </th>
                <th scope=" row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="font-normal text-gray-500 dark:text-white"> {{ ucwords($cancha->ciudad) }}</div>
                </th>
                <!-- BOTONES DE ACCION  -->
                    ...
                    <div x-data="{ open: false, coords: { top: 0, left: 0 } }" class="inline-block">
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <ul class="flex flex-col">
                                {{-- VER --}}
                                <li>
                                    <a wire:click="verEstadio({{ $cancha->id }})" class="cursor-pointer flex items-center w-full px-4 py-2 
                                ...
                                <li>
                                    @adminOrCan('comision')
                                    <a href="{{ route('canchas.editar', $cancha->id) }}" class="flex items-center w-full px-4 py-2 
                                                    text-gray-800 dark:text-white 
                                                     hover:bg-gray-100 dark:hover:bg-gray-600 
                                ...
                                <li>
                                    @adminOrCan('comision')
                                    <a wire:click="eliminarEstadio({{ $cancha->id }})" class="flex items-center w-full px-4 py-2 
                                                    text-gray-800 dark:text-white 
                                                    hover:bg-gray-100 dark:hover:bg-gray-600 
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <div x-data="{ open: false, top: 0, left: 0 }" class="relative" @keydown.escape.window="open=false"
                    ...
                    <div x-ref="menu" x-cloak x-show="open" @click.away="open=false"
                        ...
                        <!-- BORRAR -->
                        <a wire:click="eliminarEstadio({{ $cancha->id }})"
                            class="cursor-pointer flex items-center gap-2 hover:underline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-6 w-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div x-data="{ show: false }" x-show="show" x-on:static-modal.window="show = true" x-cloak
        ...
        <div class="bg-gradient-custom bg-blue-900 dark:bg-gray-800 rounded-xl shadow-2xl max-w-xl w-full p-6 sm:p-8 relative transform transition-all scale-100 opacity-100 ease-out duration-300
