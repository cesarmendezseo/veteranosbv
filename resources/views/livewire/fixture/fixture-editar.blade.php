            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <input wire:model="fecha_edit.{{ $encuentro->id }}" type="date"
                            class="border rounded px-2 py-1 w-full">
                    </td>
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <input wire:model="hora_edit.{{ $encuentro->id }}" type="time"
                            class="border rounded px-2 py-1 w-full">
                    </td>
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <input wire:model="fecha_encuentro_edit.{{ $encuentro->id }}" type="number" min="1"
                            class="border rounded px-2 py-1 w-full">
                    </td>
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <select wire:model="cancha_id_edit.{{ $encuentro->id }}"
                            class="border rounded px-2 py-1 w-full">
                    ...
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <input wire:model="gol_local.{{ $encuentro->id }}" type="number" min="0"
                            class="border rounded px-2 py-1 w-full">
                    </td>
                    <td class="px-4 py-2 border dark:text-gray-800">
                        <input wire:model="gol_visitante.{{ $encuentro->id }}" type="number" min="0"
                            class="border rounded px-2 py-1 w-full">
                    </td>
                    ...
                    <td class="px-4 py-2 border dark:text-gray-200 text-center">{{ $encuentro->fecha_encuentro }}</td>
                    <td class="px-4 py-2 border dark:text-gray-200">{{ $encuentro->cancha->nombre }}</td>
                    <td class="px-4 py-2 border dark:text-gray-200">{{ $encuentro->equipoLocal->nombre }} ({{
                        $encuentro->gol_local ?? '-' }})</td>
                    <td class="px-4 py-2 border dark:text-gray-200">{{ $encuentro->equipoVisitante->nombre }} ({{
                        $encuentro->gol_visitante ?? '-' }})</td>
                    <td class="px-4 py-2 border dark:text-gray-200">
