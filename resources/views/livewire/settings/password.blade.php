...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Actualizar Contraseña')"
        :subheading="__('Asegúrese de que su cuenta utilice una contraseña larga y aleatoria para mantener la seguridad.')">
        <form method="POST" wire:submit="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-end">
                    <flux:button variant="primary" type="submit" class="w-full cursor-pointer">{{ __('Guardar') }}
                    </flux:button>
                </div>
