        ...
        <div
            ...
            <form wire:submit.prevent="actualizarJugador" class="max-w-2xl mx-auto" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-3 md:gap-6">
                    ...
                    <!-- DOCUMENTO -->
                    <div class="relative z-0 w-full mb-5 group">
                        <input disabled wire:model="documento" type="number" name="documento" id="floating_first_name"
                            value="{{ old('documento') }}"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-red-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('provincia') border-red-500 @enderror"
                            placeholder=" " />
                        <label for="floating_first_name"
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <div class="relative max-w-sm">
                            <div
                                class="cursor-pointer absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                    ...
                    <!-- SOCIO -->
                    <div class="relative z-0 w-full mb-5 group">
                        <input wire:model="num_socio" type="number" name="socio" id="floating_first_name"
                            value="{{ old('socio') }}"
                ...
                <div class="flex justify-between mt-4">
                    <button type="submit"
                        class="cursor-pointer px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 shadow">
