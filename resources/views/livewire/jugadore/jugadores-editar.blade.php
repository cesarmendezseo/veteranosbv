<div class="max-w-sm w-full lg:max-w-full lg:flex">
    ...
    <div class="w-full p-4 text-center bg-gray-100 border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-4 text-3xl font-bold text-gray-900 dark:text-white underline">Crear Jugador</h5>
        <form wire:submit.prevent="actualizarJugador" class="max-w-2xl mx-auto" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                ...
                <!-- DOCUMENTO -->
                <div class="relative z-0 w-full mb-5 group">
                    <input disabled wire:model="documento" type="number" name="documento" id="floating_first_name" value="{{ old('documento') }}"
