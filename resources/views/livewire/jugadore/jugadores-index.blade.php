     ...
     <x-navbar titulo="Listado de Jugadores">
         ...
         <div class="mt-2 hidden md:table">
             <input type="text" wire:model.defer="search" wire:keydown.enter="buscar"
                 placeholder="Buscar por nombre, apellido o DNI" class="border rounded px-3 py-2.5 w-full mb-2" />
         </div>
     </x-navbar>
                             ...
                             <th scope="row"
                                 ...
                                 @if ($jugador->foto)
                                     <div class="mb-4 flex justify-center">
                                         <div
                                             class="w-18 h-18 rounded-full border-4 border-gray-300 shadow-lg overflow-hidden">
                                 ...
                                 @else
                                     <div
                                         class="w-18 h-18 rounded-full border-4 border-gray-300 shadow-lg overflow-hidden flex items-center justify-center">
                                         <div
