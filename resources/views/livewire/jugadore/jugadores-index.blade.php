 <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
             ...
             <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                 ...
                 <th class="text-center align-center px-6 py-4">
                     <p class="flex items-center">
                         @if($jugador->is_activo)
                         <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300">
                         ...
                         @else
                         <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">
                             <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
     ...
     <div x-data="{ show: false }"
         ...
         <div class="bg-gradient-custom dark:bg-gray-800 rounded-xl shadow-2xl max-w-xl w-full p-6 sm:p-8 relative transform transition-all scale-100 opacity-100 ease-out duration-300
             ...
             <div class="grid grid-cols-1 md:grid-cols-1 gap-y-4 gap-x-6 text-gray-700 dark:text-gray-300">
                 <p class="flex items-center pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                     <strong class="font-semibold text-white dark:text-gray-100 mr-2">Jugador Activo:</strong>
                     @if($jugadorSeleccionado->is_activo)
                     <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300">
                         <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                         </svg>
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-1 gap-y-4 gap-x-6 text-[#efb810] font-semibold dark:text-gray-300">
                     ...
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Nombre :</strong> {{ ucfirst($jugadorSeleccionado->apellido) }} {{ ucfirst($jugadorSeleccionado->nombre) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Fecha de Nac:</strong> {{ ucfirst($jugadorSeleccionado->fecha_nac) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">N° Socio:</strong> {{ ucfirst($jugadorSeleccionado->num_socio) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Teléfono:</strong> {{ ucfirst($jugadorSeleccionado->telefono) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Email:</strong> {{ ucfirst($jugadorSeleccionado->email) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Ciudad:</strong> {{ ucfirst($jugadorSeleccionado->ciudad) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Provincia:</strong> {{ ucfirst($jugadorSeleccionado->provincia) }}
                     </p>
                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Cod Pos:</strong> {{ ucfirst($jugadorSeleccionado->cod_pos) }}
                     </p>

                     <p class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-700">
                         <strong class="font-semibold text-gray-400 dark:text-gray-100">Equipo:</strong> {{ ucfirst($jugadorSeleccionado->equipo->nombre ?? 'Sin equipo')}}
                     </p>
                 </div>
