        ...
        @adminOrCan()
         ...
         <div class="mt-2 hidden md:table">
             <input
                 ...
                 class="border rounded px-3 py-2.5 w-full mb-2" />
         </div>
     </x-navbar>
     ...
     <div class="grid grid-cols-1 gap-4 sm:hidden">
         ...
         <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 border border-gray-200 dark:border-gray-700">
             ...
             <div class="flex justify-end">
                 <div x-data="{ open: false }" class="relative">
                     ...
                     <div x-show="open" @click.away="open = false"
                         ...
                         <a href="{{ route('jugadores.editar', $jugador->id) }}"
                             class="px-3 py-2 text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600">
                             Editar
                         </a>
                         ...
                         <a href="{{ route('jugadores.foto.upload', $jugador->id) }}"
                             class="px-3 py-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600">
                             Foto
                         </a>
                     </div>
                 </div>
             ...
             <div class="flex justify-center mb-4">
                 ...
                 @else
                 <div class="w-20 h-20 rounded-full border-4 border-gray-300 shadow-lg overflow-hidden flex items-center justify-center">
                     <svg class="w-10 h-10 text-gray-400 dark:text-gray-600" fill="currentColor" viewBox="0 0 20 18">
                         <path d="M18 0H2a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
                     </svg>
                 </div>
                 @endif
             </div>
             ...
             <div class="flex justify-center my-2">
                 @if($jugador->is_active)
                 <span class="inline-flex w-6 h-6 items-center justify-center rounded-full bg-green-100 text-green-800">
                     ✓
                 </span>
                 @else
