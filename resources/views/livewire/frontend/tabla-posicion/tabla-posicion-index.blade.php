                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <div class="hidden md:flex gap-2 justify-end">
                                     ...
                                     <a href="{{ route('tabla-posicion-resultados', $campeonato->id) }}" type="button" class="text-[#0638a3] hover:underline   font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
