<div>
    <x-frontend :title="__('Fixture')">
        ...
        <div class="w-full ">
            ...
            <!-- FILTROS ESCRITORIO-->
            <div
                class="hidden md:block mb-4 grid grid-cols-1 md:grid-cols-1 gap-4 bg-gray-200 p-3 rounded-lg shadow-md">
                <p class="text-lg font-semibold text-gray-800 dark:text-white ">Elija como fitrar:</p>
                <!-- Filtros -->
                <div
                    class=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-2 bg-gray-200 p-3 rounded-lg shadow-md">
            ...
            <div class=" md:hidden">
                ...
                <div x-data="{ show: false }" class="md:hidden w-full">
                    ...
                    <button @click="show = true"
                        ...
                        Filtros Adicionales
                        <svg x-show="!show" class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div x-show="show" x-cloak x-transition.opacity x-transition.scale @click.away="show = false"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <input wire:model.live="equipoFiltro" type="text"
                ...
                <div class="mb-6">
                    ...
                    <div class="hidden sm:block ">
                        <table
                            ...
                            <thead
                                class="text-xs text-gray-100 uppercase bg-gray-500 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                            ...
                            <tbody>
                                @foreach ($encuentros as $encuentro)
                                    <tr
                                        ...
                                        <td
                                            class="px-2 sm:px-4 py-2 text-right text-sm text-gray-800 font-semibold  dark:text-gray-200">
                                            {{ strtoupper($encuentro->equipoLocal->nombre) }}
                                        </td>
                                        <td class="w-16 px-1 sm:px-2 py-2 text-center dark:border-gray-200">
                                            <div
                                                class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 text-gray-950 font-bold mx-auto">
                            ...
                            <div
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span
                                            class="w-12 h-12 flex items-center justify-center rounded-full bg-gray-200 text-gray-900 font-bold">
                                            {{ $goles_local[$encuentro->id] ?? 0 }}
                                        </span>
                                    </div>
