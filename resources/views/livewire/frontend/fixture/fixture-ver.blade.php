            ...
            <div class=" md:hidden">
                ...
                <div x-data="{ show: false }" class="md:hidden w-full">
                    ...
                    <button @click="show = true"
                        class="w-full flex items-center justify-center p-2.5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:ring-blue-800">
                        Otros Filtros
                    ...
                    <div x-show="show" x-cloak x-transition.opacity x-transition.scale @click.away="show = false"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">Filtros adicionales</h2>
                            ...
                            <div class="space-y-4">
                                ...
                                <input type="text" wire:model.live="jornadaFiltro" placeholder="Jornada"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
