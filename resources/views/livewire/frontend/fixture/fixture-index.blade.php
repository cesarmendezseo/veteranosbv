                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                ...
                                <div class="hidden md:flex gap-2 justify-end">
                                    {{-- ver --}}
                                    <a href="{{route('frontend.fixture.verFixture', $campeonato->id)}}" wire:click="fixture({{ $campeonato->id }})"
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md p-4">
                    ...
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="text-gray-600 hover:text-black focus:outline-none dark:text-white">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 z-50 flex flex-col gap-2 dark:bg-gray-800 dark:border dark:border-gray-700 p-2 rounded-lg">
                                ...
                                <a href="{{ route('frontend.fixture.verFixture', $campeonato->id) }}" class="hover:underline font-roboto">Ver</a>
                            </div>
                        </div>
                    </div>
