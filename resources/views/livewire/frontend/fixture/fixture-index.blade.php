                            ...
                            <td class="px-6 py-4 text-right">
                                ...
                                <div class="hidden md:flex gap-2 justify-end">
                                    {{-- ver --}}
                                     ...
                                     <a href="{{route('frontend.fixture.verFixture', $campeonato->id)}}" type="button" class="text-[#0638a3] hover:underline   font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
