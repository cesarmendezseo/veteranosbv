<div class="relative w-full min-h-screen flex items-center justify-center 
    ...
    <div class="relative z-10 max-w-4xl w-full p-10 rounded-3xl space-y-6
        ...
        <a href="{{ Route('frontend.estadistica.tarjetas', $campeonato->id) }}" class="flex items-center justify-between bg-blue-600 text-white rounded-2xl p-5
                  shadow-md hover:shadow-xl transition-all duration-200">

            <div>
                <h2 class="text-xl font-semibold">Tarjetas</h2>
                <p class="text-sm opacity-90">Ver las tarjetas rojas y amarillas</p>
            </div>
