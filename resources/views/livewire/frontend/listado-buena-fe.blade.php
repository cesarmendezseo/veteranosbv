    ...
    <div
        ...
        <div class="overflow-x-auto rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.3)] mb-10">
            <div class="hidden lg:block">
                <table class="w-full text-sm text-center text-black dark:text-white bg-white/5 backdrop-blur-xl">
            ...
            <div
                ...
                <div class="space-y-2 mb-4">
                    <div class="flex items-start justify-between">
                        <div class="font-semibold text-black dark:text-white">Estado:</div>
                        <div class="text-right flex-shrink-0 max-w-[70%]">
                            @if ($sancionesJugador->isNotEmpty())
                            @foreach ($sancionesJugador as $sancion)
                            <div class="space-y-2">
                                <div
                                ...
                                <div class="text-xs text-black dark:text-white text-right">
                                    @if($sancion->periodo_texto)
