<div class="relative overflow-x-auto shadow-md sm:rounded-lg dark:bg-gray-600">
    ...
    <div class="grid grid-cols-3 gap-4 mb-4 bg-gray-500 m-2 text-white p-2 rounded ">
        ...
        <div>
            ...
            <input type="text" wire:model.live.debounce.500ms="buscar" placeholder="Nombre, apellido o DNI"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div
            ...
            <div class="flex justify-between items-center border-b py-1">
                ...
                <button wire:click="agregarJugador({{ $jug->id }})"
                    class="bg-green-500 text-white hover:bg-green-400 px-2 py-1 rounded cursor-pointer">Agregar</button>
            </div>
            @endforeach
        </div>
        @endif
