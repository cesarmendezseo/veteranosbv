<div>
    <x-navbar titulo="Listado Buena Fe ">
        ...
        <button wire:click="actualizarSanciones"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="mr-1 lucide lucide-refresh-ccw-dot-icon lucide-refresh-ccw-dot">
    ...
    <flux:separator />
    <div class="mb-4 mt-2 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <!-- Año -->
        <div>
            <select wire:model.live="anioSeleccionado"
    ...
    {{-- <h2 class="text-xl font-bold mb-4">Equipo - {{ $equipo->nombre }}</h2>
    --}}
    <div class="p-4">
        ...
        <div class="overflow-x-auto"> {{-- Added for horizontal scrolling --}}
            <div class="overflow-y-auto max-h-[600px]">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-[#FFC107]">
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-3 py-2 border dark:text-gray-200 hidden sm:table-cell">
                                {{ $loop->iteration }}
                            </td> {{-- Hidden on mobile --}}
                            <td
                                @adminOrCan()
