                    ...
                    <tbody class="block md:table-row-group">
                        ...
                        <tr class="block md:table-row odd:bg-white even:bg-gray-300 border-b dark:border-gray-700">
                            <td data-label="Jugador"
                                class="block md:table-cell px-6 py-4 font-semibold text-gray-900 dark:text-gray-700 text-left">
                            ...
                            <td data-label="Gol" class="block md:table-cell px-6 py-4 text-left md:text-center">
                                <input type="number" wire:model.defer="datosJugadores.{{ $jugador->id }}.goles"
                                    class="w-full md:w-14 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg p-2.5"
                                    placeholder="0" />
                            </td>
                            ...
                            <td data-label="Doble Amarilla"
                                class="block md:table-cell px-6 py-4 text-left md:text-center">
                                <input type="checkbox"
