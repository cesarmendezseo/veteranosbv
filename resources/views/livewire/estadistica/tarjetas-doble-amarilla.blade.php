<div class="space-y-4">
        ...
        <table class="w-full text-sm sm:text-base text-left text-gray-700 dark:text-gray-100">
            <thead class="text-xs sm:text-sm uppercase bg-gray-700 dark:bg-gray-700 text-yellow-400">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center">Doble Amarillas</th>
                    <th class="px-4 py-2">Partido</th>
                </tr>
            </thead>
            <tbody>
                @forelse($dobleAmarillas as $jug)
                <tr class="border-b dark:border-gray-600">
                    ...
                    <td class="px-4 py-2 text-center">{{ $jug->tarjeta_doble_amarilla }}</td>
                    <td class="px-4 py-2">
                ...
                <tr>
                    <td colspan="5" class="px-4 py-6 text-center text-gray-500">
                        ...
                        @else
                        No hay registros de doble amarilla en este campeonato.
                        @endif
                    </td>
                </tr>
                @endforelse
    ...
    <div class="sm:hidden space-y-4">
        ...
        <div class="bg-yellow-50 dark:bg-gray-800 rounded-lg shadow p-4 text-sm text-gray-800 dark:text-gray-100">
            ...
            <div><span class="font-semibold">Doble Amarillas:</span> {{ $jug->tarjeta_doble_amarilla }}</div>
