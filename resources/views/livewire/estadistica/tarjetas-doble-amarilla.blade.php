<div>
    ...
    @if ($jugadorBuscadoDobleAmarilla && $jugadorBuscadoDobleAmarilla->isNotEmpty())
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($jugadorBuscadoDobleAmarilla as $estadistica)
                <tr
    ...
    @elseif(!empty($buscarDobleAmarilla))
    <a href="#"
    ...
    @endif
    {{-- Mostrar $Amarillas SOLO cuando no hay resultados de búsqueda --}}
    @if ($dobleAmarillas && empty($jugadorBuscadoDobleAmarilla))
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-2x1 text-gray-100 uppercase bg-gray-500 dark:bg-purple-900 dark:text-[#FFC107]">
                <tr>
            ...
            <tbody>
                @foreach ($dobleAmarillas as $estadistica)
                <tr
                    class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                    <td class="px-6 py-4">
                        {{ $estadistica->jugador->documento }}
