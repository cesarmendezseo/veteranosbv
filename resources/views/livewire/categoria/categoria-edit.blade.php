<div>
    ...
    <div class="max-w-sm w-full lg:max-w-full lg:flex">
        ...
        <div
            ...
            <form wire:submit.prevent="actualizarCategoria" class="max-w-2xl mx-auto mt-4"
                ...
                <div class="grid md:grid-cols-1 md:gap-6">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <a href="{{ route('categoria.index') }}"
                            class="bg-blue-950 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-blue-800">
