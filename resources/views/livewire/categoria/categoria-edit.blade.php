            ...
            <form wire:submit.prevent="actualizarCategoria" class="max-w-2xl mx-auto mt-4" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-1 md:gap-6">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <a href="{{ route('categoria.index') }}" class="bg-blue-950 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-blue-800"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 9-3 3m0 0 3 3m-3-3h7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                            Volver</a>
                    </div>
