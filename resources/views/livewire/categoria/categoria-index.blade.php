     ...
     <div class="md:hidden space-y-4 min-h-screen">
         ...
         <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4 border dark:border-gray-700">
             <div class="flex justify-between items-center mb-2">
                 <h3 class="text-lg font-bold text-gray-900 dark:text-white"><span class="text-gray-600 dark:text-accent">Categoría:</span> {{ucwords($categoria->nombre)}}</h3>
                 <div x-data="{ open: false }" class="relative">
                     ...
                     <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 bg-white dark:bg-gray-700 shadow rounded-lg z-50 flex flex-col">
                         ...
                         <a wire:click="verCategoria({{ $categoria->id }})" class="cursor-pointer px-3 py-2 text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600">Ver</a>
                     </div>
                 </div>
             </div>
