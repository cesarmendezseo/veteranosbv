    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <h2 class=" font-semibold text-xl text-gray-100 leading-tight">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('config.finalizarCampeonato') }}"
                    class="  text-white bg-blue-400 p-1 hover:bg-blue-200  hover:text-black rounded flex items-center gap-1 cursor-pointer">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-badge-plus-icon lucide-badge-plus">
                        <path
                        ...
                        " class="text-gray-600 hover:text-black focus:outline-none dark:text-white cursor-pointer">
                            ...
                            <div x-ref="menu" x-cloak x-show="open" @click.away="open=false"
                                ...
                                <button wire:click="eliminarCampeonato({{ $campeonato->id }})"
                                    ...
                                    </svg><span class="ml-1">Eliminar</span>
                                </button>
                                @endadminOrCan
                                {{-- ver --}}
                                ...
                                @endadminOrCan
                                @adminOrCan('administrador|comision')
                                <a href="{{ route('config.campeonato', $campeonato->id) }}"
                                    class="cursor-pointer flex items-center gap-2 hover:underline dark:text-white "
                                    title="Equipos">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        <path
                                            d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z" />
                                    </svg><span class="ml-1">Configurar Campeonato</span>
                ...
                <div class="flex justify-between items-center mb-2">
                    ...
                    <div x-data="{ open: false, top: 0, left: 0 }" class="relative" @keydown.escape.window="open=false"
                        ...
                        <div x-ref="menu" x-cloak x-show="open" @click.away="open=false"
                            ...
                            {{-- ASIGNAR EQUIPO --}}
                            <a href="{{ route('asignar-equipos', $campeonato->id) }}"
                                class="flex items-center gap-2 hover:underline" title="Equipos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-shirt-icon lucide-shirt">
                                    <path
