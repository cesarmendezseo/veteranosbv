...
<body class="bg-[#2a5eb1] dark:bg-[#0a0a0a] text-[#1b1b18] flex flex-col min-h-screen ">
    <div x-data="{ show: false }" x-init="window.addEventListener('scroll', () => { show = window.scrollY > 200 })" class="fixed bottom-3 right-3">
    ...
    <div class="flex-grow w-full">
        <div class="w-full max-w-screen-xl mx-auto px-4 overflow-x-hidden id=" navbar-sticky" x-cloak
            ...
            @endpush
            <nav x-data=" { open: false }" @popstate.window="open = false"
                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 sha">
                    <div class="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                        <a href="#"
                            ...
                            <img src="{{ asset('images/logo.jpeg') }}" alt="Logo de Futbol de Veteranos"
                            ...
                            <ul
                                ...
                                <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                        ...
                                        class=" h-6 w-6 lucide lucide-house-icon lucide-house text-slate-500">
                                    ...
                                    <a href="{{ route('pagina.principal') }}"
                                        class="flex items-center hover:underline">Inicio</a>
                                </li>
                                <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                    ...
                                    <a href="{{ route('tabla-posicion-index') }}"
                                        class="flex items-center hover:underline">Tabla Posición</a>
                                </li>
                                ...
                                <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                    ...
                                    <a href="{{ route('frontend.fixture.index') }}"
                                        class="flex items-center hover:underline">Fixture</a>
                                </li>

                                <li>
                                    <svg class="text-slate-100" width="2" height="24" viewBox="0 0 2 24"
                                    ...
                                    @if (Route::has('login'))
                                        @auth
                                            <a href="{{ url('/dashboard') }}"
                                                class="flex items-center hover:underline">Dashboard</a>
                                        @else
                                            <a href="{{ route('login') }}" class="flex items-center hover:underline"><svg
                        ...
                        <button @click="open = !open"
                            class=" text-slate-100 relative ml-auto h-6 max-h-[40px] w-6 max-w-[40px] select-none rounded-lg text-center align-middle text-xs font-medium uppercase text-inherit transition-all hover:bg-transparent focus:bg-transparent active:bg-transparent disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:hidden"
                            type="button">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-300"
                    ...
                    x-transition:leave-end="opacity-0 transform scale-95" class="lg:hidden">
                    <div class="px-4 pb-4">
                        ...
                        <ul class="flex flex-col gap-2">
                            ...
                            <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    class="w-6 h-6 lucide lucide-house-icon lucide-house text-slate-500">
                                    <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" />
                                    <path
                                        d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                                </svg>
    ...
    <footer class="mt-5 bg-[#2a5eb1] dark:bg-gray-900 text-gray-300 dark:text-gray-300">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between">
            ...
            <!-- Texto -->
            <p class="text-sm">
                © {{ date('Y') }} <span class="font-semibold text-yellow-500">Fútbol de Veteranos</span>. Todos
