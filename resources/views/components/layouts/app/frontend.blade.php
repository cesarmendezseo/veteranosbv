                ...
                <div class="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                    <a href="#" class="mr-4 block cursor-pointer py-1.5 text-base text-slate-800 font-semibold">
                        <img
                            ...
                            alt="Logo de Futbol de Veteranos"
                    ...
                    <div class="hidden lg:block">
                        <ul class="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                            <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=" h-6 w-6 lucide lucide-house-icon lucide-house text-slate-500">
                                    <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" />
                                    <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                                </svg>

                                <a href="{{route('pagina.principal')}}" class="flex items-center hover:underline">Inicio</a>
                            </li>
                            <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                            ...
                            <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                                @if (Route::has('login'))
                                @auth
                                <a href="{{ url('/dashboard') }}" class="flex items-center hover:underline">Dashboard</a>
                                @else
                                <a href="{{ route('login') }}" class="flex items-center hover:underline"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
            ...
            <div
                ...
                <div class="px-4 pb-4">
                    ...
                    <ul class="flex flex-col gap-2">
                        ...
                        <li class="flex items-center p-1 text-sm gap-x-2 text-slate-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 lucide lucide-house-icon lucide-house text-slate-500">
                                <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" />
                                <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                            </svg>
                            <a href="{{route('pagina.principal')}}" class="flex items-center hover:underline">Inicio</a>
