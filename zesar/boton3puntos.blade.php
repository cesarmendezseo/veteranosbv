<div x-data="{ open: false, coords: { top: 0, left: 0 } }" class="inline-block">
    ...
    <button @click="
        ...
        <!-- Icono menú -->
        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 cursor-pointer text-gray-800 dark:text-white"
    ...
    <!-- Dropdown -->
    <div x-show="open" x-cloak class="fixed w-48 bg-white dark:bg-gray-700 rounded shadow-lg z-[9999]"
        ...
        <ul class="flex flex-col">
            ...
            <li>
                <a wire:click="verJugador({{ $jugador->id }})" class="cursor-pointer flex items-center w-full px-4 py-2 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5 h-5 mr-2 text-gray-800 dark:text-white">
            ...
            <li>
                ...
                <a href="{{ route('jugadores.editar', $jugador->id) }}" class="flex items-center w-full px-4 py-2 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="h-6 w-6 text-gray-800 dark:text-white">
                        <path stroke-linecap="round" stroke-linejoin="round"
